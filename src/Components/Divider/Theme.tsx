        ...
        dividerBox: {
            base: {
                css: {
                    ...
                    borderTop: `1px solid ${props.configConsumerTheme.divider.borderColor}`,

                    ...(!!props.dashed && {
                        background: "none",
                        borderColor: props.configConsumerTheme.divider.borderColor,
                        borderStyle: "dashed",
                        borderWidth: "1px 0 0",
                    }),
                    ...
                    ...(props.type === "vertical" && {
                        ...
                        borderTop: 0,
                        borderLeft: `1px solid ${props.configConsumerTheme.divider.borderColor}`,
                    }),
                    ...(props.hasChildren && {
                        display: "flex",
                        margin: "16px 0",
                        ...
                        textAlign: "center",
                        borderTop: 0,
                        borderTopColor: props.configConsumerTheme.divider.borderColor,
                        borderTopWidth: "0px"
                    }),
                },
                pseudos: {
