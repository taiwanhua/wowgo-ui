...
const Template: Story<ISectionProps> = (args) => (<WowgoUIProvider><Section  {...args} /></WowgoUIProvider>);

export const SectionWithBorder = Template.bind({});
SectionWithBorder.args = {
    children: "這是一個 Section 組件，並覆寫其邊框線顏色為1像數的黑色實線",
...
SectionWithBorder.parameters = {
    docs: {
        source: {
            language: "jsx",
            code: `
<Section theme={(style, uiStore, porpsFromDom, utils) => {
        return {
            base: {
                css: {
                    ...style.base.css,
...
>
    這是一個 Section 組件，並覆寫其邊框線顏色為1像數的黑色實線
</Section>
`,
        },
    },
